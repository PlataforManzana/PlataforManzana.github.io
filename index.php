...
<head>
    ...
    <!-- Title -->
    <title>Plataforma de Asesoría tecnica y comercialización para productores de manzana</title>
 ...
 -->                                            <li><a href="course.php">Manzana</a></li>
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                               <!--  <a href="tel:(771)1844361"><i class="icon-telephone-2"> </i> <span>Omitlán de Juárez</span></a> -->
                            </div>
                        </div>
                    </nav>
                </div>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 data-animation="fadeInUp" data-delay="100ms">Todos los cursos que necesitas</h4>
                                <h2 data-animation="fadeInUp" data-delay="400ms">Asesoría técnica y comercialización <br>para productores de manzana</h2>
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/bg-a.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 data-animation="fadeInUp" data-delay="100ms">Compra y vende Manzana</h4>
                                <h2 data-animation="fadeInUp" data-delay="400ms">Asesoría Técnica y Comercialización <br>para productores de manzana</h2>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Leer más</a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto white wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <h3>See what our satisfied customers are saying Acerca de nosotros us</h3>
                    </div>
                </div>
            </div>
            <div class="row"> -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta-content d-flex align-items-center justify-content-between flex-wrap">
                        <h3>Comunidad, Omitlán de Juárez, Hidalgo</h3>
                        <a href="#" class="btn academy-btn">Ver más</a>
                    </div>
                </div>
            </div>
